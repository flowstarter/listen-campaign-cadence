...
transaction(listingResourceID: UInt64) {
    ...
    prepare(acct: AuthAccount) {
        self.ListenStorefront = acct.borrow<&ListenMarketplace.ListenStorefront{ListenMarketplace.ListenStorefrontManager}>(from: ListenMarketplace.ListenStorefrontStoragePath)
